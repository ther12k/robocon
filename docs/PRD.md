...
| **M5 Polish & Beta** | Replay record/playback panel ✅ (done 2026-08: deterministic replays with checkpoint verification and match-session support); remaining: minimap, telemetry graphs, i18n, sharing links | Beta to pilot teams (3–5 universities); feedback round |
